                        ...
                        <tr class="transition hover:bg-[var(--color-neutral-50)]">
                                        ...
                                        @else
                                            <div class="flex h-full w-full items-center justify-center text-[var(--color-text-muted)]">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <path stroke-linecap="round"
                                                          stroke-linejoin="round"
                                                          d="M4 16l4.5-4.5a2 2 0 012.828 0L16 16m-2-2l1.5-1.5a2 2 0 012.828 0L20 15m-2-9h.01M5 19h14a2 2 0 002 2H5a2 2 0 01-2-2V7a2 2 0 012-2h14a2 2 0 012 2z"/>
                                                </svg>
                                            </div>
                                        @endif
                            ...
                            <td class="px-5 py-4">
                                <span class="inline-flex rounded-full bg-[var(--color-brand-50)] px-3 py-1 text-xs font-bold text-[var(--color-brand-700)]">
                                    {{ number_format($category->products_count ?? $category->products()->count()) }}
                                    محصول
                                </span>
                            </td>
                            ...
                            <td colspan="5" class="px-5 py-16 text-center">
                                <div class="mx-auto max-w-sm">
                                    ...
                                    <p class="mt-2 text-sm text-[var(--color-text-secondary)]">
                                        هنوز دسته‌بندی‌ای ثبت نشده یا فیلترهای فعلی نتیجه‌ای ندارند.
                                    </p>
